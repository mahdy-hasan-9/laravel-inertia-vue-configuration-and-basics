...
const menuItems = ref([
    ...
    { name: 'Conversation', href: route('conversation.index'), routeName: 'conversation.index' },
...
<template>
    <div class="min-h-screen bg-gray-50 flex flex-col font-sans">
        ...
        <!-- Main Content Dynamic Slot (Adjusted padding for mobile view compatibility) -->
        <main class="flex-grow max-w-7xl w-full mx-auto px-2 sm:px-6 lg:px-8 py-3 sm:py-6 lg:py-8">
            <slot>
