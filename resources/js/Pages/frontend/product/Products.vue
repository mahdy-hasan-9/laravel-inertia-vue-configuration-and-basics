...
const debouncedSearch = debounce(() => filterProducts(['products']), 400)
    ...
    <ProductLayout>
        <template #sidebar-search>
            ...
            <div class="relative">
                ...
                <div v-if="isProcessing" class="absolute left-3 top-2.5">
            ...
            <div class="space-y-4 z-1000">
                ...
                <div v-if="selectedVendor">
                    ...
                    <Deferred data="brands">
                        <template #fallback>
                            <div class="h-9 bg-gray-100 animate-pulse rounded-lg"></div>
                        </template>
        ...
        <div class="relative min-h-[400px]">
            <SmoothFade mode="out-in">
                <div v-if="isProcessing" key="loading"
